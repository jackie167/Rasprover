...
echo "== slam node pids =="
for name in slam_base slam_bridge slam_mux slam_joy slam_joystick slam_lidar slam_laser_tf slam_ekf slam_slam; do
...
echo "== slam logs =="
for name in base bridge mux joy joystick lidar laser_tf ekf slam; do
